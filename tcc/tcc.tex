...
\begin{document}
  ...
  \end{equation}
  em que $V_{\rm in}$ \'e a tens\~ao de entrada. Esta entrada \'e chamada de desbalanceada, pode ser conectada diretamente ao est\'agio de ganho---tratado na pr\'oxima subse\c c\~ao---atrav\'es de um jumper em JP1. Ela est\'a mais sucet\'ivel \`a interfer\^encia eletromagn\'etica {\it radio frequency} (RF), por exemplo proveniente do uso cabos longos.
