...
\begin{document}
  ...
  \]
  Referindo-se a \cite{HH}, um \ampop\ diferencial \'e aquele cuja sa\'ida \'e inteiramente independente dos sinais individuais, importando apenas a diferen\c ca entre eles. Por\'em, como se nota em (\ref{saida_ampop_real}), $V_{\rm out}$ depende da tens\~ao dos sinais injetados nas entradas, a saber, da sua m\'edia aritm\'etica, e n\~ao apenas de sua diferen\c ca. \`A vista disto, em aplica\c c\~oes de \ampop{s} diferenciais deseja-se que o comportamento seja o mais pr\'oximo de um \ampop\ ideal, isto for\c ca o projetista a tornar o m\'odulo de $G_c$ muito pequeno, em outros termos o mais pr\'oximo de 0. Destarte, quanto menor $|G_c|$, tanto menor ser\'a sua suscetibilidade a ru\'idos provenientes de distintas fontes. Na eletr\^onica existe uma grandeza que mensura a imunidade do circuito a ruidos n\~ao correlacionados, \'e o {\bf CMRR} ({\it Common-Mode Rejection Ratio}\/), em portugu\^es {\bf raz\~ao de rejei\c c\~ao de modo-comum}, doravante a referiremos simplesmente por CMRR. Ela \'e definida por
  \[
