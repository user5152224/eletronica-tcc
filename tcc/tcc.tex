...
\begin{document}
  ...
  \section{Est\'agio de ganho}
  Na confec\c c\~ao do esquem\'atico do estágio de ganho, por questões pragmáticas há divergências nas numera\c c\~oes dos resistores neste trabalho e no artigo da Elektor \cite{SelfElektor}, quando o \'indice $i$ for maior que 70 leia-se $i+2$, este impasse se deve \`as numera\c c\~oes das coordenadas dos elementos.
  
  \iffalse % \iffalse IGNORAR; \iftrue COMPILAR.
