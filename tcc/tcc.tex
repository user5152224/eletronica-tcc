...
\begin{document}
  ...
  \begin{figure}[]
    \centering
    \ctikzset{amplifiers/fill=green!35}
...
%  \end{figure}
  ...
  \begin{figure}[!ht]
    ...
    \begin{circuitikz}[scale=.42, rotate=90, transform shape]
      \ctikzset{
        european,
      }
      ...
      \draw (NINIC7A)  to [short, -o] ++(0,.7*\dmv) coordinate (IC7)  node [above=.2cm] {$K_5$};
      \draw (NINIC15A) to [short, -o] ++(0,.7*\dmv) coordinate (IC15) node [above=.2cm] {$K_6$};
      \draw (NINIC23A) to [short, -o] ++(0,.7*\dmv) coordinate (IC23) node [above=.2cm] {$K_9$};
      \draw (NINIC31A) to [short, -o] ++(0,.7*\dmv) coordinate (IC31) node [above=.2cm] {$K_{10}$};

      \draw (R47) to [short, -o] (R47 |- IC7)  node [above=.2cm] {$K_7$};
      \draw (R63) to [short, -o] (R63 |- IC15) node [above=.2cm] {$K_8$};
      \draw (R79) to [short, -o] (R79 |- IC23) node [above=.2cm] {$K_{11}$};
      \draw (R95) to [short, -o] (R95 |- IC31) node [above=.2cm] {$K_{12}$};

      \foreach \i in {0,...,3} {
        \pgfmathsetmacro{\j}{int(7+8*\i)}
