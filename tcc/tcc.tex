...
\begin{document}
  ...
  IC2B \'e um seguidor de tens\~ao, logo, seu ganho \'e unit\'ario. Sua fun\c c\~ao \'e prevenir a imped\^ancia de entrada de $1\,{\rm k}\Omega$ do est\'agio de ganho final IC3B, de carregar a sa\'ida de IC2A, causando distor\c c\~ao. IC2B \'e menos vuner\'avel a cargas, porque ela tem uma retroalimenta\c c\~ao negativa m\'axima. 

  Em IC3B, no pino 6, segue da lei de Kirchhoff a igualdade
  \[
