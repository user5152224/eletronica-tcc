...
\begin{document}
  ...
  Ao posicionar um resistor de resist\^encia $R$ na entrada de um bom amplificador de \'audio, digamos, com imped\^ancia de entrada $Z_{\rm in}$, a tens\~ao de ru\'ido $V_n$ efetivamente vista pelo amplificador \'e dada pelo divisor de tens\~ao
  \[
  ...
  \]
  conforme mencionado no artigo. Como a corrente em IC2A \'e neglig\'ivel, temos pela LKC
  \[
  ...
  \]
  Como o est\'agio de pot\^encia \'e composto precipuamente de seguidores de tens\~ao em paralelo, segue da LKC (lei de Kirchhoff para correntes) que a corrente total de sa\'ida $I_{\rm T(out)}$ do est\'agio de pot\^encia \'e
  \[
    I_{\rm T(out)}=64\cdot34\,{\rm mA}=2,176\,\rm A
  \]
  o que resulta em uma pot\^encia em rms numa carga de $8\,\Omega$ de
  \[
    P_{\rm rms}=\Bigl({2,176\over\sqrt{2}}\Bigr)^2\cdot8\approx19\,{\rm W_{rms}}
  \]
